...
15. **Ops contracted**: `healthcheck()`, `stuck_work_overview`, `campaign_progress`; 11 roles / 15 workflow definitions; exact n8n version + reference deployment pinned in `golden/baseline.md`; SC-001 measured p95 excluding approval wait.
